...
?>
    ...
    <section class="main" id="main__section">
      ...
      <div class="container mt-4">
          <div class="row">
              <div class="col-12 col-md-4">
                      ...
                      <div class="row card-header">
                        ...
                        <div class="col-8">
                          <select name="" onchange="filtrarVentas(event)" class="form-control bg-success" style="color:#fff" id="">
                            <option value="YYYY-MM-DD">Ventas del dia</option>
                            <option value="YYYY-MM">Ventas del mes</option>
                  ...
                  <a href="ventas.php">Ver en detalle</a>
              </div>
              <div class="col-12 col-md-4">
                    ...
                    <div class="row card-header">
                      ...
                      <div class="col-6">
                        <select name="" onchange="filtrarPagoProveedores(event)" class="form-control bg-danger" style="color:#fff" id="">
                          <option value="YYYY-MM-DD">Pagos del dia</option>
                          <option value="YYYY-MM">Pagos del mes</option>
                  ...
                  <a href="proveedores.php">Ver en detalle</a>
              </div>
              <div class="col-12 col-md-4">
                    ...
                    <div class="row card-header">
                      ...
                      <div class="col-6 ml-auto">
                        <select name="" onchange="filtrarServicio(event)" class="form-control bg-warning" style="color:#fff" id="">
                          <option value="No pago">Valor a pagar</option>
                          <option value="all">Todos del mes</option>
                        </select>
                      </div>
                    </div>
                    <div class="card-body">
                  ...
                  <a href="servicios.php">Ver en detalle</a>
              </div>
          </div>
      </div>
      <hr>
      ...
      <div class="container">
          <div class="row">
              <div class="col-12 col-md-4">
                  ...
                  <a href="pedidos.php">Ver en detalle</a>
              </div>
              <div class="col-12 col-md-4">
              ...
              <div class="col-12 col-md-4">
                  ...
                  <a href="deudores.php">Ver en detalle</a>
              </div>
      ...
      <div class="container my-4">
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-6 text-center">
            ...
            <p class="mt-2" id="infoMasVendido">Es el producto más vendido durante el período seleccionado</p>
          </div>
        </div>
      </div>
